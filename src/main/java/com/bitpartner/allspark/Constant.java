...
public class Constant {
    ...
    public static String GMAIL_ID = "bitpartnerkorea@gmail.com";
    public static String GMAIL_NAME = "BitPartnerKorea";
    public static String GMAIL_PW = "hnofund1234";
    public static String GMAIL_SUBJECT = "[BitPartner]메일 인증 코드입니다.";

    public static String GMAIL_HOST = "smtp.gmail.com";
    public static int GMAIL_PORT = 465;
